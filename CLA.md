...
2. You confirm that you have the right to make this contribution
   and that it does not infringe on any third-party rights.

3. This CLA applies to all contributions made by you to this project,
   past and future.

This ensures the project can be maintained and relicensed if needed
while keeping the codebase free for everyone under Apache 2.0.
